...
import com.example.myappcancheito.postulante.Nav_Fragments_Postulante.FragmentInicioPostulante
import com.example.myappcancheito.postulante.Nav_Fragments_Postulante.FragmentOfertas
...
class MainActivityPostulante : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(FragmentInicioPostulante())
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.op_inicio_c -> replaceFragment(FragmentOfertas())
